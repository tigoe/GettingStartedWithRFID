These code samples, in Arduino and Processing, are for my book "Getting Started with RFID". Note that the Arduino examples are all written forArduno 1.0, so will not work in versions 22 or earlier.
